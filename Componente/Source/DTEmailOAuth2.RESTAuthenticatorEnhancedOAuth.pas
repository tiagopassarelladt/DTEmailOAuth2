unit DTEmailOAuth2.RESTAuthenticatorEnhancedOAuth;
...
type
  ...
  private
    procedure RequestAccessToken(clientID, ClientSecret : string);
  public
    IDToken : string;
    procedure ChangeAuthCodeToAccesToken;
    procedure RefreshAccessTokenIfRequired(clientID, ClientSecret : string);
    function AuthorizationRequestURI(clientID, ClientSecret : string): string;
  end;
...
function TEnhancedOAuth2Authenticator.AuthorizationRequestURI(clientID, ClientSecret : string): string;
var
  uri : TURI;
begin
...
procedure TEnhancedOAuth2Authenticator.RefreshAccessTokenIfRequired(clientID, ClientSecret : string);
begin
...
procedure TEnhancedOAuth2Authenticator.RequestAccessToken(clientID, ClientSecret : string);
var
  LClient: TRestClient;
